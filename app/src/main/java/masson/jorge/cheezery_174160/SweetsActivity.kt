...
class SweetsActivity : AppCompatActivity() {
    ...
    fun cargarProductos() {
        ...
        sweets.add(Product("Red Velvet cake", R.drawable.redvelvetcake, "Soft, moist, buttery cake with an easy cream cheese frosting.", 6))
        ...
        sweets.add(Product("Tiramisu", R.drawable.tiramisu, "Coffe-flavored Italian dessert.", 7))
