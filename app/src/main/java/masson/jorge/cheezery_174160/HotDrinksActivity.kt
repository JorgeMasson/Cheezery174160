...
class HotDrinksActivity : AppCompatActivity() {
    ...
    fun cargarProductos() {
        ...
        hotDrinks.add(Product("Espresso", R.drawable.espresso, "Full-flavored, concentraded form of coffee", 4))
        hotDrinks.add(Product("Chai latte", R.drawable.chailatte, "Spiced tea concentrate with milk", 6))
        hotDrinks.add(Product("Capuccino", R.drawable.capuccino, "A capuccino is an espresso-based coffee drink, prepared with steamed foam", 7))
